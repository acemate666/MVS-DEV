...
下面这张图对应 `curve_v3/core.py` 的真实编排（函数名与代码一致）：
...
类型定义集中在 `curve_v3/types.py`，核心对象如下：
...
对应实现位置：`curve_v3/low_snr/`，说明文档：`../docs/07_low_snr_policy.md`。
